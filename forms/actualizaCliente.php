        ...
        <div id="content">
            ...
            <div class="panel box-shadow-none content-header">
                <div class="panel-body" style="align-content: center">
                    <div class="col-md-12">
                        <h3 class="animated fadeInLeft">Alta de Clientes</h3>
                        ...
                        <div class="panel">
                            <div class="panel-body">
                                ...
                                ?>
                                    ...
                                    <form action="../controllers/updateVenta.php?a=guardar&id=<?php echo $_GET['id'] ?>" method="post">

                                        <div class="form-group form-animate-text" style="margin-top:40px !important;">
                                            <input type="text" class="form-text" value="<?php echo $nombre; ?>"  name="nombre_cliente" required>
                                            <span class="bar"></span>
                                            <label>Nombre</label>
                                        </div>
                                        <div class="form-group form-animate-text" style="margin-top:40px !important;">
                                            <input type="text" class="form-text" value="<?php echo $direccion; ?>" name="direccion" required>
                                            <span class="bar"></span>
                                            <label>Direccion</label>
                                        </div>
                                        <div class="form-group form-animate-text " style="margin-top:40px !important;">
                                            <input type="text" class="form-text " value="<?php echo $telefono; ?>" name="telefono" required>
                                            <span class="bar "></span>
