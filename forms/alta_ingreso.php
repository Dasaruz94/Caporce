        ...
        <div id="content">
            ...
            <div class="panel box-shadow-none content-header">
                <div class="panel-body" style="align-content: center">
                    <div class="col-md-12">
                        <h3 class="animated fadeInLeft">Alta de Ingresos</h3>
                        ...
                        <div class="panel">
                            <div class="panel-body">
                                <div class="col-md-12 padding-0" style="padding-bottom:20px;">
                                    <form action="../controllers/updateIngresos.php?a=create" method="post">

                                        <div class=" form-group">

                                            <label></span>Fecha de ingreso</label><br>
                                            <?php echo date('d-m-Y');?>
                                        </div>
                                        <div class="form-group form-animate-text" style="margin-top:40px !important;">
                                            <input type="number" class="form-text"  name="precio" required>
                                            <span class="bar"></span>
                                            <label>Monto</label>
                                        </div>
                                        <label>Descripciòn del Ingreso</label>
                                        <textarea rows="4" cols="50" name="descripcion" id="descripcion">
                                        </textarea>
                                        <br><br><br>
