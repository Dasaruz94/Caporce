    ...
    <script type="text/javascript">
        function comprobarClave(){
            ...
            if (clave1 == clave2){
                ...
                document.form1.action='../controllers/updateUsuario.php?a=add';
                    ...
                    <div class="panel-body">
                        <div class="col-md-12 padding-0" style="padding-bottom:20px;">
                                ...
                                <form action="" name="form1" id="form1">
                                    ...
                                    <div class="form-group form-animate-text" style="margin-top:40px !important;">
                                        <input type="password" class="form-text" id="password1" name="password1" required>
                                        <span class="bar"></span>
                                    ...
                                    <button type="button" onclick="comprobarClave()" class="btn btn-success">Dar de Alta</button>
