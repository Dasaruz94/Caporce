...
if(isset($_SESSION['nombre'])) {
    ...
    if($_SESSION['tipo_usuario']!= 3){
        ...
        $tablaDeMysql2 = "producto_venta"; //Define el nombre de la tabla donde estan los datos


        //Checamos si se lleno el campo de usuario en el formulario


        $consulta2 = "SELECT * FROM ".$tablaDeMysql2." WHERE id_ventas LIKE ".$_GET['idVenta']."";
        $resultado2 = $mysqli->query($consulta2);

        $total = mysqli_num_rows($resultado2); //Contamos la cantidad de filas que nos arrojo el resultado
        ...
        <script type="text/javascript">
            var counter = <?php echo $total; ?>;
            var total = 0;
            var contador1 = 0;
            var limit = 10;
            var contador = <?php echo $total; ?>;
            var valor = 0;
            var precio = 0;
            var importe = 0;
        ...
        <form action="../controllers/updateVenta.php?a=modificaNota&id=<?php echo $_GET['idVenta']; ?>&idCliente=<?php echo $_GET['id']; ?>" method="post">
            <div class="col-md-9"></div>
            <div class="col-md-3 form-group ">
                <p>No. nota de venta. <?php
                    echo $_GET['idVenta'];
                    ?></p>
            </div>
            ...
            <div class="row">
                <div class="col-md-12" id="insertar">
                    ...
                    ?>
                    <div class="col-md-2 form-group form-animate-text">
                        <input type="text" class="form-text" id="cantidad_<?php echo $contador; ?>" value="<?php echo $cantidad; ?>" name="cantidad_<?php echo $contador;?>" required>
                        <span class="bar"></span>
                        <label><span class="fa fa-list-ol"></span> Cantidad</label>
                    </div>

                    <div class="col-md-4 form-group form-animate-text">
                        <input type="text" class="form-text " id="descripcion_<?php echo $contador; ?>" value="<?php echo $descripcion; ?>" name="descripcion_<?php echo $contador;?>" required>
                        <span class="bar"></span>
                        <label><span class="fa fa-pencil-square"></span>Descripción</label>
                    </div>

                    <div class="col-md-2 form-group form-animate-text">
                        <input type="text" class="form-text " id="kilos_<?php echo $contador; ?>" value="<?php echo $kilos; ?>" name="kilos_<?php echo $contador;?>" required>
                        <span class="bar"></span>
                        <label><span class="fa fa-calendar"></span> Kilos</label>
                    </div>
                    <div class="col-md-2 form-group form-animate-text">
                        <input type="text" class="form-text " id="precio_unitario_<?php echo $contador; ?>" value="<?php echo $punitario; ?>" name="precio_unitario_<?php echo $contador;?>" required>
                        <span class="bar"></span>
                        <label><span class="fa fa-dollar"></span> P. Unitario</label>
                    </div>
                    <div class="col-md-2 form-group form-animate-text">
                        <input type="text" class="form-text " id="importe_<?php echo $contador; ?>" value="<?php echo $importe; ?>" name="importe_<?php echo $contador;?>" required>
                        <span class="bar"></span>
                        <label><span class="fa fa-dollar"></span> Importe</label>
                    </div>
        ...
        <button type="button" onclick="submit()"  class="btn btn-success">Modificar nota</button>
