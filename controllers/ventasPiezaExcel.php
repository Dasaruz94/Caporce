...
// Set properties
    ...
    $objPHPExcel->getProperties()->setTitle("Reporte Ventas Filtro");
    $objPHPExcel->getProperties()->setSubject("Reporte Ventas Filtro");
    $objPHPExcel->getProperties()->setDescription("Reporte Ventas Filtro");
...
//Nos va servir para obtener los labels de cada campo
    ...
    $tituloReporte = "Ventas con filtro";
...
//forma sencilla de dar estilos
    ...
    $nombreArchivo = "ReporteVentasFiltro". date('d-m-Y');
