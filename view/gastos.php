        ...
        <div id="content">
            ...
            <div class="panel box-shadow-none content-header">
                <div class="panel-body" style="align-content: center">
                    <div class="col-md-12">
                        <h3 class="animated fadeInLeft">Gastos</h3>
                    </div>
                </div>
            </div>
                            ...
                            <div class="panel-body">
                                <div class="col-md-12 padding-0" style="padding-bottom:20px;">
                                    <div class="col-md-6" style="padding-left:10px;">
                                        ...
                                        <div class="col-md-3">
                                            <a href="../forms/alta_gasto.php">
                                                <button class="btn-flip btn btn-gradient btn-primary" onclick="">
                                                    <div class="flip">
                                                        <div class="side">
                                                            Nuevo Gasto <span class="icon-user-follow"></span>
                                                        </div>
                                                        <div class="side back">
                                                            Agregar Nuevo
                                                        </div>
                                ...
                                <div class="responsive-table">
                                    ...
                                    <table class="table table-striped table-bordered " width="100%" cellspacing="0">
                                        ...
                                        $tablaDeMysql = "gastos"; //Define el nombre de la tabla donde estan los datos


                                        //Checamos si se lleno el campo de usuario en el formulario


                                        $consulta = "SELECT * FROM ".$tablaDeMysql." WHERE activo LIKE 1 AND fecha_pago = '".date('Y-m-d')."' ";
                ...
                <script type="text/javascript">
                    ...
                    function Pregunta(id){
                        ...
                        if(confirm("¿Estas seguro que desea borrar el Gasto seleccionado?")){
                            document.location.href="../controllers/updateGasto.php?a=delete&id="+id+"";
